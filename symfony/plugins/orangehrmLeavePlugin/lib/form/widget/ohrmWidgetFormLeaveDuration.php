...
class ohrmWidgetFormLeaveDuration extends sfWidgetForm {
    ...
    protected function configure($options = array(), $attributes = array()) {
        ...
        $this->addOption('template', '%duration% %full_day_content%');
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        orangehrm.widgets.formLeaveDuration.handleDurationChange($("#%duration_id%").val(), '%full_day_content_id%');
        $("#%duration_id%").change(function() {
            orangehrm.widgets.formLeaveDuration.handleDurationChange($(this).val(), '%full_day_content_id%');
        });    
    });
