...
abstract class BaseEmployeeForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'psipopClass'           => new sfWidgetFormInputText(),
      ...
      'biometricId'           => new sfWidgetFormInputText(),
      'bloodType  '           => new sfWidgetFormInputText(),
      ...
      'classification'        => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('classification'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'psipopNo'              => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'psipopClass'           => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      ...
      'biometricId'           => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'bloodType'             => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      ...
      'classification'        => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('classification'), 'required' => false)),
