...
abstract class BaseEmployeeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'psipopClass'           => new sfWidgetFormFilterInput(),
      ...
      'biometricId'           => new sfWidgetFormFilterInput(),
      'bloodType  '           => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'psipopNo'              => new sfValidatorPass(array('required' => false)),
      'psipopClass'           => new sfValidatorPass(array('required' => false)),
      ...
      'biometricId'           => new sfValidatorPass(array('required' => false)),
      'bloodType'             => new sfValidatorPass(array('required' => false)),
      ...
      'classification'        => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('classification'), 'column' => 'id')),
