            ...
            $rawDataSet = $reportableGeneratorService->generateReportDataSet($reportId, $sql);
             ...
             if ($downloadExcel == 1) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)
                 ...
                 foreach ($rawDataSet as $rd) {
                       $i++;
                            ...
                            (empty($rd['driversLicenseNumber'])) ? $driversLicenseNumber = '' : $driversLicenseNumber = $rd['driversLicenseNumber'];
                            (empty($rd['licenseExpiryDate'])) ? $licenseExpiryDate = '' : $licenseExpiryDate = $rd['licenseExpiryDate'];
                            (empty($rd['otherId'])) ? $otherId = '' : $otherId = $rd['otherId'];
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                            ...
                            ->setCellValue('I'.$i,$driversLicenseNumber)
                            ->setCellValue('J'.$i,$licenseExpiryDate)
                            ->setCellValue('K'.$i,$otherId)
                ...
                $objPHPExcel->setActiveSheetIndex(0)
                            ...
                            ->setCellValue('I2', 'Driver License Number')
                            ->setCellValue('J2', 'License Expiry Date')
                            ->setCellValue('K2', 'Other Id')
