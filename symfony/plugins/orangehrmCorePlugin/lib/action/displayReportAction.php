            ...
            $rawDataSet = $reportableGeneratorService->generateReportDataSet($reportId, $sql);
             ...
             if ($downloadExcel == 1) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)
                 ...
                 foreach ($rawDataSet as $rd) {
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                            ...
                            ->setCellValue('K'.$i,$homeTelephone)
                            ->setCellValue('L'.$i,$mobile)
                            ->setCellValue('M'.$i,$workTelephone)
                            ->setCellValue('N'.$i,$workEmail)
                            ->setCellValue('O'.$i,$otherEmail)
                            ->setCellValue('P'.$i,$ecname)
                            ->setCellValue('Q'.$i,$ecHomeTelephone)
                            ->setCellValue('R'.$i,$ecWorkTelephone)
                            ->setCellValue('S'.$i,$ecRelationship)
                            ->setCellValue('T'.$i,$ecMobile)
                            ->setCellValue('U'.$i,$dependentName)
                            ->setCellValue('V'.$i,$dependentRelationship)
                            ->setCellValue('W'.$i,$dependentDateofBirth)
                            ->setCellValue('X'.$i,$edSeqNo)
                ...
                $objPHPExcel->setActiveSheetIndex(0)
                            ...
                            ->setCellValue('J2', 'Address')
                            ->setCellValue('K2', 'Home Telephone')
                            ->setCellValue('L2', 'Mobile')
                            ->setCellValue('M2', 'Work Telephone')
                            ->setCellValue('N2', 'Work Email')
                            ->setCellValue('O2', 'Other Email')
                            ->setCellValue('P2', 'Name')
                            ->setCellValue('Q2', 'Relationship')
                            ->setCellValue('R2', 'Date of Birth ')
                            ->setCellValue('S2', 'Membership')
                            ->setCellValue('T2', 'Subscription Paid By')
                            ->setCellValue('U2', 'Subscription Amount')
                            ->setCellValue('V2', 'Currency')
                            ->setCellValue('W2', 'Subscription Commence Date')
                            ->setCellValue('X2', 'Subscription Renewal Date')
